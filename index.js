...
const UUID = process.env.UUID || '09911e13-507f-4285-ba39-4c04b19c380d'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const HY2_PORT = process.env.HY2_PORT || '3001';                // hy2端口，支持多端口的可以填写，否则留空
